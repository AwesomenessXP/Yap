//
//  BetterConvexQuery.swift
//  Yap
//
//  Created by Shrey on 2/20/24.
//
...
public final class QueryLoader: ObservableObject {
    ...
    func updateArgsAndSubscribe(newArgs: [String: Value], client: Client?) {
            ...
            // Resubscribe with the updated arguments
